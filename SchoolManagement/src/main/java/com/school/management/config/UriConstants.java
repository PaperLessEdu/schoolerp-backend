...
/**
 * This class defines all the constants used in the application
 */
public class UriConstants {
	...
	public static final String HOLIDAY_ID = "/{holidays_id}";
	...
	public static final String SCHOOL_PROFILE_ID="/{schoolProfile_id}";
}
